...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <div id="mobile-nav" className="flex md:order-2">
    ...
    <svg id="theme-toggle-light-icon" className="hidden w-5 h-5" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <image href={sunIcon} width="20" height="20" />
