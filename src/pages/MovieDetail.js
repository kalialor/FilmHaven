...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=65178ab71cb23431f03dfb05fde24b97
      `)
...
/* we are using data to get the property from the api. in this case, 
we are grabbing the title from the json file. 
